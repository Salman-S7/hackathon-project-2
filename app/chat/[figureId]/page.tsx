...
const figuresData = {
  ambedkar: {
    ...
    era: "1891-1956",
    image:
      "https://images.pexels.com/photos/8847615/pexels-photo-8847615.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
    background:
      "Principal architect of the Indian Constitution, social reformer, and champion of Dalit rights.",
    personality:
      "Thoughtful, determined, eloquent, and deeply committed to social justice and equality.",
    welcomeMessage:
      "Namaste! I am Dr. Bhimrao Ramji Ambedkar. I have spent my life fighting for social justice and equality. How may I assist you in understanding the principles of justice, equality, and the importance of education?",
  },
  gandhi: {
    name: "Mahatma Gandhi",
    ...
    era: "1869-1948",
    image:
      "https://images.pexels.com/photos/8847617/pexels-photo-8847617.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
    background:
      "Leader of Indian independence movement through non-violent resistance and civil disobedience.",
    personality:
      "Peaceful, wise, humble, and deeply spiritual with unwavering commitment to truth and non-violence.",
    welcomeMessage:
      "Greetings, my friend. I am Mohandas Karamchand Gandhi. Truth and non-violence have been my guiding principles. What wisdom can I share with you today?",
  },
  einstein: {
    ...
    era: "1879-1955",
    image:
      "https://images.pexels.com/photos/8847616/pexels-photo-8847616.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
    background:
      "Developer of theory of relativity, Nobel Prize winner, and one of the most influential physicists.",
    personality:
      "Curious, imaginative, humble about the mysteries of the universe, and passionate about peace.",
    welcomeMessage:
      "Guten Tag! I am Albert Einstein. The universe is a wonderful mystery, and I've spent my life trying to understand its secrets. What questions about science, life, or the cosmos can I help you explore?",
  },
};
...
const generateResponse = (figureId: string): string => {
  ...
  const figureResponses =
    responses[figureId as keyof typeof responses] || responses["einstein"];
      ...
      <div className="bg-white/80 backdrop-blur-sm border-t px-4 py-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xs text-gray-500 mt-2 text-center">
            Responses are generated by AI and may not reflect the actual views
